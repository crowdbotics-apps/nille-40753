"""
Django settings for nille_40753 project.
...
WSGI_APPLICATION = 'nille_40753.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "nille_40753 API",
    "DESCRIPTION": "API documentation for nille_40753 App",
    "VERSION": "v1",
}
